package B_Land
{
	import common.game.BaseGameViewEvent;
	...
	public class GameViewEvent extends BaseGameViewEvent
	{
		...
		public static const nGVM_SORT_CARD:int = 0xff+1000;//排序自己加的
		public function GameViewEvent(nMsg:int=0, nWParam:*=0, nLParam:*=0)
		{
